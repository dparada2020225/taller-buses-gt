...
export function LoginForm() {
  ...
  async function handleGoogle() {
    ...
    await signIn.social({ provider: 'google', callbackURL: '/inicio' })
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <button
        ...
        className="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#6DC424] focus:ring-offset-2 disabled:opacity-60 transition flex items-center justify-center gap-2.5"
      >
        <GoogleIcon />
