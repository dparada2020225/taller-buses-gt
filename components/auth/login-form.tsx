...
export function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <button
        type="button"
        className="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#6DC424] focus:ring-offset-2 transition flex items-center justify-center gap-2.5"
      >
        <GoogleIcon />
        Google
      </button>
