...
export async function Topbar({ titulo }: { titulo?: string }) {
  ...
  // getSession ya incluye el campo 'nombre' del usuario real en BD
  ...
  return (
    <header className="flex h-14 items-center justify-between border-b border-gray-200 bg-white px-6">
      ...
      <div className="ml-auto flex items-center gap-3">
        ...
        <Link
          href="/perfil"
          className="h-8 w-8 rounded-full bg-[#0f0f0f] flex items-center justify-center text-[#6DC424] text-sm font-bold hover:opacity-80 transition"
          title="Mi perfil"
        >
